...
Remove-Module ConvertToPsd1 -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ConvertToPsd1\ConvertToPsd1.psd1"
Import-Module "$PSScriptRoot\..\ConvertToPsd1\ConvertToPsd1.psm1" -Force

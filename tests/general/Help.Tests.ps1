...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ConvertToPsd1\functions", "$global:testroot\..\ConvertToPsd1\internal\functions"),
	
	[string]
	$ModuleName = "ConvertToPsd1",
...
$CommandPath = @(
    "$global:testroot\..\ConvertToPsd1\functions"
    "$global:testroot\..\ConvertToPsd1\internal\functions"
)
